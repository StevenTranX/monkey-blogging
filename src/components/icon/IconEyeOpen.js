...
const IconEyeOpen = ({ className = "", onClick = () => {} }) => {
  // ?? Vì sao ở đây chúng ta lại truyền className
  // * Vì chúng ta muốn IconEye này có những style riêng thay vì chúng ta code cố định
  // ?? Tại sao lại là onClick
  // * Vì sau này khi phát triền password chúng ta sẽ có chức năng show mật khẩu,
  return (
